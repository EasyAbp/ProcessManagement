...
using EasyAbp.ProcessManagement.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(ProcessManagementBlazorServerModule)
)]
public class ProcessManagementBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(ProcessManagementResource),
                typeof(ProcessManagementDomainModule).Assembly,
                typeof(ProcessManagementDomainSharedModule).Assembly,
                typeof(ProcessManagementApplicationModule).Assembly,
                typeof(ProcessManagementApplicationContractsModule).Assembly,
                typeof(ProcessManagementBlazorHostModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("ProcessManagement");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/EasyAbp.ProcessManagement.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<ProcessManagementBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(ProcessManagementBlazorHostModule).Assembly;
        });
    ...
    public async override Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "ProcessManagement API");
        });
